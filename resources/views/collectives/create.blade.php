                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('collectives.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea rows="5" cols="30"  class="form-control @error('description') is-invalid @enderror" name="description"  required autocomplete="description">{{ old('description') }}</textarea>
